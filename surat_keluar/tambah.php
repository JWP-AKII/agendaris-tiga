...
if (isset($_POST['submit'])) {
    ...
    $sql= 
    "INSERT INTO surat_keluar(nomor_surat, tanggal_surat, tujuan, nomor_agenda, buku_id, status)
    VALUES('$nomor_surat', '$tanggal_surat', '$tujuan', '$nomor_agenda', '$buku', '$status')";
...
<form action="" method="post">
    ...
    <label for="tujuan">Pengirim</label>
